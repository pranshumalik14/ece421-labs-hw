...
\begin{document}
    ...
    a) Taking a random variable $X$, with the probability distribution 
    ...
    (\text{undergraduate})=w_1$ and $P(\text{graduate})=w_2$. Further using 
    the approximation $P(|X-\mu_X|\leq\sigma_X) = \frac{2}{3}$, we get $P
